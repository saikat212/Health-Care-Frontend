...
import SubmittedTestListCard from "./pending-ack-test-list-card";
import PendingACKTestListCard from "./pending-ack-test-list-card";

export default function PendingACKListUI() {
  ...
  API.diagnosticCenter.getPendingACK(id as number).then((response) =>{
