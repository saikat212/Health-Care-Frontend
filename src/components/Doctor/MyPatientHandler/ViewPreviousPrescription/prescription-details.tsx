  ...
  >
    ...
    <Grid item>
      ...
      >
        ...
        >
          <Grid item>
            <Typography sx={{ fontWeight: "bold" }}>Dr.Kamrul Hasan</Typography>
          </Grid>
          <Grid item>
    ...
    <Grid item>
      ...
      >
        ...
        >
          <Grid item>
            <Typography sx={{ fontWeight: "bold" }}>Prescription Timeline</Typography>
          </Grid>
          <Grid item>
            <Typography></Typography>
          </Grid>
        ...
        >
          ...
          <Grid item>
            ...
            >
              <Grid item>
                <Typography sx={{ fontWeight: "bold" }}>When</Typography>
              </Grid>
              <Grid item>
              <Grid item>
